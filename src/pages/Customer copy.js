                ...
                this.state.customer.map((item) => {
                    return (
                        <tr className="text-center" key={item.id}>
                            ...
                            <td>
                                <Link to={`/customer/${item.id}/edit`} className="btn btn-primary btn-small margin-right-10" title="Edit">
                                    <i className="fa fa-edit"></i>
                                </Link>
                                <button onClick={() => deleteProduct(item.id)} className="btn btn-danger btn-small" title="Delete">
                                    <i className="fa fa-trash"></i>
                                </button>
                            </td>
                        </tr>
